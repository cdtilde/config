...
(custom-theme-set-faces
 ...
 ;; basic
 `(default ((t (:foreground ,textcolor :background ,paper))))
 ...
 `(isearch ((t (:background "gold1" :foreground "black"))))    
 `(lazy-highlight ((t (:background "purple1" :foreground "white"))))
 ...
 ;; header line
 `(header-line ((t (:background ,paper))))
